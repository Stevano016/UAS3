...
<div class="container my-5 py-5" id="features">
    <div class="text-center mb-5">
        <h2 class="display-6 fw-bold mb-3"><span class="text-primary">FoodieVote</span> hadir sebagai solusi inovatif untuk menemukan,<br>mengulas, dan merekomendasikan makanan terbaik<br>di kota Anda.</h2>
    </div>
...
<div class="container my-5 py-5">
    <div class="text-center mb-5">
        <h2 class="display-6 fw-bold mb-3"><span class="text-primary">FoodieVote</span> menawarkan berbagai keuntungan yang dapat<br>membantu Anda menemukan pengalaman kuliner<br>terbaik.</h2>
    </div>
    
    <div class="row g-4">
        <div class="col-md-6">
            <div class="program-card">
                <img src="https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=600" alt="Pecinta Kuliner" class="program-img">
                <div class="program-content">
                    <span class="program-badge">Pecinta Kuliner</span>
                    <ul class="text-muted">
                        <li>Temukan restoran dan makanan baru sesuai selera Anda dengan mudah.</li>
                        <li>Akses review dan rating jujur dari komunitas foodie terpercaya.</li>
                        <li>Dapatkan inspirasi menu untuk berbagai kesempatan dan budget.</li>
                        <li>Bagikan pengalaman kuliner Anda dan bantu orang lain menemukan tempat terbaik.</li>
                        <li>Simpan daftar favorit dan wishlist restoran yang ingin dikunjungi.</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="program-card">
                <img src="https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=600" alt="Pemilik Restoran" class="program-img">
                <div class="program-content">
                    <span class="program-badge">Pemilik Restoran</span>
                    <ul class="text-muted">
                        <li>Tingkatkan visibilitas restoran Anda di mata ribuan pencari kuliner.</li>
                        <li>Dapatkan feedback langsung dari pelanggan untuk meningkatkan kualitas layanan.</li>
                        <li>Promosikan menu spesial dan event dengan jangkauan yang lebih luas.</li>
                        <li>Analisis performa restoran melalui rating dan review pelanggan.</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="program-card">
                <img src="https://images.unsplash.com/photo-1600565193348-f74bd3c7ccdf?w=600" alt="Food Blogger" class="program-img">
                <div class="program-content">
                    <span class="program-badge">Food Blogger & Influencer</span>
                    <ul class="text-muted">
                        <li>Platform untuk berbagi ulasan kuliner dan membangun kredibilitas sebagai food critic.</li>
                        <li>Jangkau audiens yang lebih luas dengan konten kuliner berkualitas.</li>
                        <li>Kolaborasi dengan restoran untuk review dan konten promosi.</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="program-card">
                <img src="https://images.unsplash.com/photo-1517457373958-b7bdd4587205?w=600" alt="Wisatawan" class="program-img">
                <div class="program-content">
                    <span class="program-badge">Wisatawan</span>
                    <ul class="text-muted">
                        <li>Temukan kuliner lokal terbaik di kota yang Anda kunjungi dengan mudah.</li>
                        <li>Hemat waktu mencari tempat makan dengan rekomendasi yang sudah terverifikasi komunitas.</li>
                    </ul>
                </div>
            </div>
        </div>
...
<div class="container my-5 py-5">
    <div class="text-center mb-5">
        <button class="btn btn-outline-primary rounded-pill px-4 mb-3">Bertemu dengan Founders</button>
    </div>
...
<div class="container my-5 py-5">
    <div class="text-center mb-5">
        <button class="btn btn-outline-primary rounded-pill px-4 mb-3">Berkenalan dengan Tim Kami</button>
    </div>
